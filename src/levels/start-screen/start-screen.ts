...
import { buttonFont } from '../../fonts/font'
import { cpuVscputext, p1VsP2Text } from './text'
import { ActorsStartScreen } from './actors'

export class StartScreen extends ex.Scene {
  title: ex.Actor = ActorsStartScreen.createTitle()
  p1VsCpuButton: ex.Actor = ActorsStartScreen.createP1VsCpuButton()
  ...
  override onInitialize(engine: ex.Engine): void {
    ...
    this.engine = engine
    this.fadeOverlay = ActorsStartScreen.createFadeOverlay(engine)
